...
@Service
public class DataRedis extends DataAbstract {

  private DatabaseFactory.Type type = DatabaseFactory.Type.REDIS;

  @Autowired private DatabaseFactory databaseFactory;

  @Override
  protected List<LayoutBlock> getConfig() throws Exception {
